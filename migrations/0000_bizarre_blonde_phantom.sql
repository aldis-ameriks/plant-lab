...
CREATE TABLE IF NOT EXISTS "user_access_keys" (
	...
	"roles" text[] NOT NULL,
	CONSTRAINT "user_access_keys_access_key_key" UNIQUE("access_key")
);
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "users_devices" (
	"user_id" bigint NOT NULL,
	"device_id" bigint NOT NULL,
	CONSTRAINT "users_devices_pkey" PRIMARY KEY("user_id","device_id")
);
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "readings_device_id_time_idx" ON "readings" ("time","device_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "readings_reading_id_time_idx" ON "readings" ("time","reading_id");--> statement-breakpoint
